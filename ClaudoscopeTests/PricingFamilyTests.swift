...
/// Tests for Claude Fable 5 (`claude-fable-5`) pricing-family support: family
/// detection, the three pricing tables, the cost-estimation path, and an
/// end-to-end parse of a Fable session record.
